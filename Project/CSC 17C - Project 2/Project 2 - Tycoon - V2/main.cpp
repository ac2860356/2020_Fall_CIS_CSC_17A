 ...
 * Purpose: Add recursion, recursive sorts, hashing, trees, and graphs
 * VERSION 1
 * Changelog: changed where recursive sorts are, added trees and hashing
 */
...
void runDiag() {
    ...
    //************************************
    cout << endl << "=========================================" << endl;
    cout << endl << "Testing hand sorting" << endl;
    cout << endl << "Showing sorted hand..." << endl;
    ...
    //*************************************
    cout << endl << "=========================================" << endl;
    cout << endl << "Testing card playing..." << endl;
    string rank;
    int amount;
    bool good2Go;
